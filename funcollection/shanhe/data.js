...
const shanheScenes = [
    ...
    // ===== 吉林 =====
    { province: 'jilin',   city: '吉林（吉B）', scene: '丰满水电站', denom: '第二套人民币5角', year: 1953, img: 'https://cdn.jsdelivr.net/gh/Tong-Xiangjie/Tong-Xiangjie.github.io@main/funcollection/shanhe/images/fmsdz-1953-05.jpg', remark: "丰满水电站位于吉林省吉林市丰满区。币面上为老坝，于2018年12月开始爆破拆除，现仅遗留有老坝左右岸各一段坝体作为历史遗迹永久矗立在原址。" },
