            ...
            copies: [
                {
                    ...
                    size: "",
                    watermark: "",
                    remark: "这张爱藏标签信息错了^_^，把第三个冠号O当作了数字0，因此标签上面写的是KA0088999，这还使得这张钞票多了一个它本来不该有的版别“连对号”，这也有点搞笑了。不过这一张我是一眼就看上的，所以一开始看到的时候拍卖出价还是3元的时候我就下定决心100以内都可以接受（虽然后来看到出价到了73还是有点肉疼ToT），不过最好还是咬咬牙买到哩~这张的数字冠O是我看上它的最大亮点，况且后面就马上紧邻一个数字0，可以很好地对比这两个字在字体上的差别！",
                    img1: "image/indonesia/ORE322444-1.jpg",
                    img2: "image/indonesia/ORE322444-2.jpg"
                }
            ]
